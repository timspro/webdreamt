 ...
 *
 * @method     ChildUsersQuery leftJoinUsersGroups($relationAlias = null) Adds a LEFT JOIN clause to the query using the UsersGroups relation
 * @method     ChildUsersQuery rightJoinUsersGroups($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UsersGroups relation
 * @method     ChildUsersQuery innerJoinUsersGroups($relationAlias = null) Adds a INNER JOIN clause to the query using the UsersGroups relation
 *
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    public function filterByUsersGroups($usersGroups, $comparison = null)
    {
        if ($usersGroups instanceof \UsersGroups) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $usersGroups->getUserId(), $comparison);
