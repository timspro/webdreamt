...
abstract class Location implements ActiveRecordInterface
{
    ...
    public function setStreetAddress($v)
    {
        ...
        if ($this->street_address !== $v) {
            ...
            $this->modifiedColumns[LocationTableMap::COL_STREET_ADDRESS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LocationTableMap::translateFieldName('StreetAddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->street_address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LocationTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LocationTableMap::translateFieldName('State', TableMap::TYPE_PHPNAME, $indexType)];
            $this->state = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : LocationTableMap::translateFieldName('Zip', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LocationTableMap::COL_STREET_ADDRESS)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collContracts) {
                ...
                $result[$key] = $this->collContracts->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setStreetAddress($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LocationTableMap::COL_STREET_ADDRESS)) {
            $criteria->add(LocationTableMap::COL_STREET_ADDRESS, $this->street_address);
        }
        if ($this->isColumnModified(LocationTableMap::COL_CITY)) {
    ...
    public function getContracts(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collContracts || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collContracts) {
                ...
                $collContracts = ChildContractQuery::create(null, $criteria)
    ...
    {
        /** @var ChildContract[] $contractsToDelete */
        ...
        foreach ($contractsToDelete as $contractRemoved) {
            $contractRemoved->setLocation(null);
        }
     ...
     * @return $this|\Location The current object (for fluent API support)
     */
    public function addContract(ChildContract $l)
    {
        if ($this->collContracts === null) {
            $this->initContracts();
            $this->collContractsPartial = true;
        ...
        if (!$this->collContracts->contains($l)) {
    ...
    /**
     * @param ChildContract $contract The ChildContract object to add.
     */
    ...
    /**
     * @param  ChildContract $contract The ChildContract object to remove.
     * @return $this|ChildLocation The current object (for fluent API support)
     */
    public function removeContract(ChildContract $contract)
    {
        if ($this->getContracts()->contains($contract)) {
            $pos = $this->collContracts->search($contract);
            $this->collContracts->remove($pos);
            ...
            $this->contractsScheduledForDeletion[]= clone $contract;
     ...
     * @return ObjectCollection|ChildContract[] List of ChildContract objects
     */
    public function getContractsJoinCustomerRelatedByBuyerCustomerId(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildContractQuery::create(null, $criteria);
     ...
     * @return ObjectCollection|ChildContract[] List of ChildContract objects
     */
    public function getContractsJoinCustomerRelatedBySellerCustomerId(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildContractQuery::create(null, $criteria);
     ...
     * @return ObjectCollection|ChildContract[] List of ChildContract objects
     */
    public function getContractsJoinAgentRelatedByBuyerAgentId(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildContractQuery::create(null, $criteria);
     ...
     * @return ObjectCollection|ChildContract[] List of ChildContract objects
     */
    public function getContractsJoinAgentRelatedBySellerAgentId(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildContractQuery::create(null, $criteria);
