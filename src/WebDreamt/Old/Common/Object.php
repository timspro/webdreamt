 ...
 * instance has not yet been retrieved, then it will create an instance. Note that an instance
 * created by calling the constuctor of a child class is not stored.  If this functionality is
 * desired, then uncomment out the constructor, but be warned that this suggests an error in
 * design because the point of this class is to enforce an object being constructed only once.
 * Calls to new Foo($a,$b) should be replaced with Foo::get(array($a,$b)).
 */
abstract class Object {
	 ...
	 * @param array $parameters An array of parameters to pass to the constructor if it needs
	 * to be called.
	 * @return Object
	 */
