...
class GroupsTableMap extends TableMap
{
     ...
     */
    const COL_PERMISSIONS = 'groups.PERMISSIONS';

    /**
     * the column name for the CREATED_AT field
     */
    const COL_CREATED_AT = 'groups.CREATED_AT';

    /**
     * the column name for the UPDATED_AT field
     */
    const COL_UPDATED_AT = 'groups.UPDATED_AT';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Permissions', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'name', 'permissions', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(GroupsTableMap::COL_ID, GroupsTableMap::COL_NAME, GroupsTableMap::COL_PERMISSIONS, GroupsTableMap::COL_CREATED_AT, GroupsTableMap::COL_UPDATED_AT, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_NAME', 'COL_PERMISSIONS', 'COL_CREATED_AT', 'COL_UPDATED_AT', ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'permissions', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Permissions' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'name' => 1, 'permissions' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(GroupsTableMap::COL_ID => 0, GroupsTableMap::COL_NAME => 1, GroupsTableMap::COL_PERMISSIONS => 2, GroupsTableMap::COL_CREATED_AT => 3, GroupsTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_NAME' => 1, 'COL_PERMISSIONS' => 2, 'COL_CREATED_AT' => 3, 'COL_UPDATED_AT' => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'permissions' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupsTableMap::COL_PERMISSIONS);
            $criteria->addSelectColumn(GroupsTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(GroupsTableMap::COL_UPDATED_AT);
        } else {
